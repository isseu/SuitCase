...
(function() {
    ...
    var update_in_cases = function() {
        if($("#user_cases_table").data('dynatable') && $("#cases_table").data('dynatable') ){
            $("#user_cases_table").data('dynatable').process();
            $("#cases_table").data('dynatable').process();
        }
    }
